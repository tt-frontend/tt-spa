...
export interface ApartmentOnChessboardResponse {
  /** @format int32 */
  id: number;
  apartmentNumber: string | null;
  /** @format int32 */
...
export interface ChessboardCreateModel {
...
export interface FloorResponse {
  ...
  apartments: ApartmentOnChessboardResponse[] | null;
}
...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @tags Chessboards
     * @name ChessboardsDetail
     * @summary HousingStocksUpdate
     * @request GET:/api/Chessboards/{housingStockId}
     * @secure
     */
    chessboardsDetail: (housingStockId: number, params: RequestParams = {}) =>
      this.request<ChessboardResponse, ErrorApiResponse>({
        path: `/api/Chessboards/${housingStockId}`,
        method: 'GET',
        secure: true,
        format: 'json',
        ...params,
     ...
     *
     * @tags Chessboards
     * @name ChessboardsCreateChessboardCreate
     * @summary HousingStocksUpdate
     * @request POST:/api/Chessboards/{housingStockId}/createChessboard
     * @secure
     */
    chessboardsCreateChessboardCreate: (
      housingStockId: number,
      data: ChessboardCreateModel,
      params: RequestParams = {},
    ) =>
      this.request<ChessboardResponse, ErrorApiResponse>({
        path: `/api/Chessboards/${housingStockId}/createChessboard`,
        method: 'POST',
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     *
     * @tags Chessboards
     * @name ChessboardsCreateFloorCreate
     * @summary HousingStocksUpdate
     * @request POST:/api/Chessboards/{housingStockId}/createFloor
     * @secure
     */
    chessboardsCreateFloorCreate: (
      housingStockId: number,
      data: FloorCreateModel,
      params: RequestParams = {},
    ) =>
      this.request<ChessboardResponse, ErrorApiResponse>({
        path: `/api/Chessboards/${housingStockId}/createFloor`,
        method: 'POST',
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     *
     * @tags Chessboards
     * @name ChessboardsCreateSectionCreate
     * @summary HousingStocksUpdate
     * @request POST:/api/Chessboards/{housingStockId}/createSection
     * @secure
     */
    chessboardsCreateSectionCreate: (
      housingStockId: number,
      data: SectionCreateModel,
      params: RequestParams = {},
    ) =>
      this.request<ChessboardResponse, ErrorApiResponse>({
        path: `/api/Chessboards/${housingStockId}/createSection`,
        method: 'POST',
        body: data,
        secure: true,
        type: ContentType.Json,
